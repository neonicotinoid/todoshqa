                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link :is-active="true" href="#">Dashboard</x-nav-link>
                                <x-nav-link :is-active="false" href="#">Projects</x-nav-link>
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <div x-data="{isOpen: false}" class="ml-3 relative">
                                <div>
                                    <button @click="isOpen = !isOpen" type="button" class="max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                                            aria-expanded="false"
                                            aria-haspopup="true">
